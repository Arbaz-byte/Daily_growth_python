...
- [ ] Load a grayscale image (e.g., using `plt.imread` or `skimage.data.camera()`).
- [ ] Perform truncated Singular Value Decomposition (SVD) on the image matrix.
- [ ] Reconstruct the image using ranks 5, 20, and 50.
- [ ] Display original and reconstructed images side‑by‑side.
- [ ] Write a markdown cell explaining compression ratio vs. image quality trade‑off.
- [ ] Write a LinkedIn post reflecting on the 7‑day sprint (screenshot to be added).
